...
public class AvailableTickets extends javax.swing.JFrame {
    ...
    public AvailableTickets() {
     ...
     Trip trip;
    public AvailableTickets(Trip T) {
        initComponents();
        this.trip = T;
        this.Tickets = T.getTripAvailableTickets();
        if(Tickets.size() != 0)
        {
    ...
    private void initComponents() {
        ...
        renterButton1.setText("Book This Ticket");
           ...
           for(int i = 0 ; i < this.Tickets.size(); i++)
          {
             ...
             if(bt.getTicketID() == Integer.parseInt(this.ticketidfield.getText()))
             {
               ...
               break;
                    ...
                    AvailableTickets Page = new AvailableTickets(this.trip);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AvailableTickets().setVisible(true);
            }
        });
    }
