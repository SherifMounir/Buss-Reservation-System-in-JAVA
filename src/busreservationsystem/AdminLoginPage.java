...
public class AdminLoginPage extends javax.swing.JFrame {
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
          ...
          if(this.Accountfield.getText().isEmpty() || this.passwordField.getText().isEmpty())
        {
         ...
         else
          {
            ...
            boolean isExist = admin.Login(this.Accountfield.getText(), this.passwordField.getText());
            if(isExist)
            {
