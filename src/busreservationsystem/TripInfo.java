...
public class TripInfo extends javax.swing.JFrame {
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        {
            Admin a = new Admin();
            Trip T = a.getTripbyID(Integer.parseInt(this.tripidfield.getText()), HomePage.Trips);
            JOptionPane.showMessageDialog(null, "Go to View Trip Info ");
            ViewTripInfo Page = new ViewTripInfo(T);
